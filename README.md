...
### Install
- Download the latest binary from the [releases](https://github.com/floss-fund/portal/releases) page.
...
- Run `./portal --upgrade` to run any database schema migrations. Run the app and visit `localhost:9000`
